<template>
  ...
  >
    ...
    <div class="setting-content px-2 py-1">
      <el-checkbox-group ref="columnRef" v-model="checkList" class="columnRef" @change="onChange">
        <template v-for="item in sortOptions" :key="item.prop">
          <div class="setting_column_item flex items-center">
            ...
            <el-tooltip effect="dark" content="固定到左侧" placement="bottom">
              <i-ep-download
                :class="[
            ...
            <el-tooltip effect="dark" content="固定到右侧" placement="bottom">
              <i-ep-download
                :class="[
                  '-rotate-90 cursor-pointer focus:outline-none',
                  {
