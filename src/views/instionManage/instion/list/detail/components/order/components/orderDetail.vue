    ...
    <div class="orderDetail">
      ...
      <div class="text-sm mb-4">
        ...
        <div>
          ...
          <span class="pr-2">联系人：{{ contactsOptions[info.contactRelation] }}{{ info.contactMobile }}</span>
      ...
      <div class="orderPart mb-4">
        ...
        <div class="text-sm text-right mt-2">
          原价{{ info.originAmount }}元，已优惠{{ info.preferential }}元 实付金额：<span class="price_real">{{ info.realAmount }}元</span>
        </div>
...
const { result: info, loading } = useRequest<Recordable>(() => reqApi.school.orderDetail({ orderId: props.orderId }), {
  defaultValue: {},
  immediate: true,
  formatResult: res => {
