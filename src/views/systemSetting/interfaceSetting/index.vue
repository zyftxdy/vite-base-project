    ...
    <el-form :model="modelRef" label-width="140px">
      ...
      <div class="instion">
        ...
        <div class="text-sm text-slate-700 font-medium">
          设置教培机构端的登录界面，<el-button link type="primary" @click="handleSample('1')"
            >点此查看示例</el-button
          >
        </div>
        <div class="flex">
        ...
        <div class="flex">
          <div class="mr-6 flex-1">
            <el-form-item label="文本一：">
              <el-input
                v-model="modelRef.ad1"
                placeholder="请填写第一行文字"
                maxlength="10"
                show-word-limit
              />
            </el-form-item>
          ...
          <div class="mr-6 flex-1">
            <el-form-item label="文本二：">
              <el-input
                v-model="modelRef.ad2"
                placeholder="请填写第二行文字"
                maxlength="10"
                show-word-limit
              />
            </el-form-item>
        ...
        <div class="flex">
          <div class="mr-6 flex-1">
            <el-form-item label="文本三：">
              <el-input
                v-model="modelRef.ad4"
                placeholder="请填写第三行文字"
                maxlength="16"
                show-word-limit
              />
            </el-form-item>
        ...
        <div class="text-sm text-gray-700 font-medium">
          设置教培机构端的管理后台界面，<el-button link type="primary" @click="handleSample('2')"
            >点此查看示例</el-button
          >
        </div>
        ...
        <div class="text-sm text-gray-700 font-medium">
          设置教培机构端的网页标签小图标，<el-button link type="primary" @click="handleSample('3')"
            >点此查看示例</el-button
          >
        </div>
        <div class="flex">
          <div class="flex-1 mr-6">
            ...
            <el-form-item label="网页标签标题：">
              <el-input
                v-model="modelRef.ad6"
                placeholder="请填写网页标签标题"
                maxlength="24"
                show-word-limit
              />
            </el-form-item>
      ...
      <div class="backstage">
        ...
        <div class="text-sm text-gray-700 font-medium">
          设置监管平台的登录界面，<el-button link type="primary" @click="handleSample('4')"
            >点此查看示例</el-button
          >
        </div>
        <div class="flex">
        ...
        <div class="text-sm text-gray-700 font-medium">
          设置监管平台的管理后台界面，<el-button link type="primary" @click="handleSample('5')"
            >点此查看示例</el-button
          >
        </div>
        <div class="flex">
          <div class="flex-1 mr-6">
            ...
            <el-form-item label="后台产品标题：">
              <el-input
                v-model="modelRef.ad8"
                placeholder="请填写后台产品标题"
                maxlength="24"
                show-word-limit
              />
            </el-form-item>
        ...
        <div class="text-sm text-gray-700 font-medium">
          设置监管平台的网页标签小图标，<el-button link type="primary" @click="handleSample('6')"
            >点此查看示例</el-button
          >
        </div>
        <div class="flex">
      ...
      <el-form-item>
        <el-button class="btn-small btn-border-color" type="primary" @click="handleClick"
          >保存修改</el-button
        >
      </el-form-item>
    </el-form>

    <el-dialog v-model="showState.show" :title="showState.title">
