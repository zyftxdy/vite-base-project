...
export default defineComponent({
  setup(_, _ref) {
    ...
    const { result, run: getData } = useRequest<Recordable[]>(() => reqApi.statistics.statisDist({ code: unref(code) }), {
      defaultValue: [],
    ...
    return () => {
      return (
        <div class="center-top">
          ...
          <div class="right">
            <div class="oper_info">
              { show.value && <span class="oper"><el-button class="btn" link size="small" onClick={ onClick }>返回上一级</el-button></span>}
            </div>
