<template>
  ...
  >
    ...
    <el-form-item label="部门名称：" prop="name">
      <el-input v-model="modelRef.name" placeholder="请填写部门名称" show-word-limit maxlength="20"/>
    </el-form-item>
...
const { run: submitForm } = useRequest(() => props.deptId ? reqApi.depart.deptUpdate(modelRef) : reqApi.depart.deptAdd(modelRef), {
  onBefore: () => {
    if (props.deptId) modelRef.deptId = props.deptId
  },
  onSuccess: () => {
