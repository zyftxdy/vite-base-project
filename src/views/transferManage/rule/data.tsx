...
export const columns = (fns: Recordable<Fn>): TableColumn[] => ([
  ...
  { label: '划拨模式', prop: 'transferMode', formatter: (row, column, cellValue) => transferModelOptions[cellValue] },
  ...
  { label: '创建人', prop: 'username' },
  {
    ...
    fixed: 'right',
    render: (val, data) => (
      <el-button link type="danger" onClick={() => fns.handleDel(data.ruleId)}>删除</el-button>
    )
  }
])
